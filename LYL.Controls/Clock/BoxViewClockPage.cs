...
{
    public class BoxViewClockPage : AbsoluteLayout, IMarkupExtension
    {
        ...
        public static readonly HandParams secondParams = new HandParams(0.02, 1.1, 0.85);
        public static readonly HandParams minuteParams = new HandParams(0.05, 0.8, 0.9);
        public static readonly HandParams hourParams = new HandParams(0.125, 0.65, 0.9);
